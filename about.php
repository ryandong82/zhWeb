...
<!-- 热线&课程 start-->
<div style="background:#cf910a;color:white;padding:5px 35px;margin-bottom:15px;" class="text-center">
    <h5>
...
<div class="sidebar course">
    ...
    <div class="sidebar-right">
        <ul class="list-group">
            ...
            <li class="list-group-item">
                <a href="http://www.boyaceo.com/promotion/show_private.php" class="default">博雅私人董事会</a>
            </li>
            <li class="list-group-item">
                <a href="http://www.boyaceo.com/promotion/show_icbc.php" class="default">博雅工商管理精品班</a>
            </li>
            <li class="list-group-item">
        ...
        <img src="http://www.boyaceo.com/statics/images/boya/child_arrow.jpg" class="child_arrow"></div>
    <div class="row">
        <div class="col-xs-6">
