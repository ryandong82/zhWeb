        ...
        <div class="row">
            ...
            <div class="col-sm-5 col-md-4 col-lg-3 hidden-xs">
                <div class="pinned-mark">
                    <!-- 热线&课程 start-->
                    <div style="background:#cf910a;color:white;padding:5px 35px;margin-bottom:15px;"
                         class="text-center">
                        <h5>
                    ...
                    <div class="sidebar course">
                        <h5 style="background:#cf910a;padding:8px 35px 8px 15px;color:white;"
                        ...
                        <div class="sidebar-right">
                            <ul class="list-group">
                                ...
                                <li class="list-group-item">
                                    <a href="http://www.boyaceo.com/course-10-5-1.html" class="default">博雅投资家高端项目</a>
                                </li>
                                <li class="list-group-item">
                                    <a href="http://www.boyaceo.com/course-10-3-1.html" class="default">博雅后EMBA高端项目</a>
                                </li>
                                <li class="list-group-item">
                                    <a href="http://www.boyaceo.com/course-10-8-1.html" class="default">博雅海外CEO课程—新加坡南洋理工大学</a>
                                </li>
                                <li class="list-group-item">
                                    <a href="http://www.boyaceo.com/course-10-15-1.html" class="default">博雅财务总监高级研修班</a>
                                </li>
                                <li class="list-group-item">
                                    <a href="http://www.boyaceo.com/course-10-16-1.html" class="default">博雅营销总监高级研修班</a>
                                </li>
                                <li class="list-group-item">
                                    <a href="http://www.boyaceo.com/course-10-17-1.html" class="default">2015博雅青少年国学经典领袖营</a>
                                </li>
                            </ul>
                            <img src="http://www.boyaceo.com/statics/images/boya/child_arrow.jpg" class="child_arrow">
                        </div>
                        <div class="row">
                            <div class="col-xs-6">
                                <a class="btn btn-warning center-block" data-toggle="modal" data-target="#application">开始申请</a>
                            </div>
                            <div class="col-xs-6">
                    ...
                    <div class="sidebar teacher">
                        ...
                        $result = $pdo->query("select a.Id, a.teacher_name, c.filename, a.teacher_descript, a.show_in_intro, a.teacher_photo, a.order_num, a.create_date,
...
<footer>
    ...
    <div style="background:#cf910a;padding:30px 0;" class="bg-footer">
        <div class='container text-center text-muted'>
            <p>
                <a href="http://www.boyaceo.com/about-1.html">关于我们</a>
                &nbsp;｜&nbsp;
                <a href="http://www.boyaceo.com/about-46.html">联系我们</a>
                &nbsp;｜&nbsp;
                <a href="http://www.boyaceo.com/list-32-1.html">友情链接</a>
                &nbsp;｜&nbsp;
